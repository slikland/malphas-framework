    ...
    for (_i = 0, _len = items.length; _i < _len; _i++) {
      ...
      _results.push((function() {
        ...
        for (_j = 0, _len1 = fields.length; _j < _len1; _j++) {
          ...
          _results1.push(input != null ? (_ref = input.getInstance()) != null ? _ref.showError(item.message) : void 0 : void 0);
        }
        return _results1;
      }).call(this));
    }
...
components.CKEditor = (function(_super) {
  __extends(CKEditor, _super);

  CKEditor.ORDER = 0;

  CKEditor.SELECTOR = '[type="ckeditor"]';

  function CKEditor() {
    this._updateTextarea = __bind(this._updateTextarea, this);
    var _ref;
    CKEditor.__super__.constructor.apply(this, arguments);
    this._editor = CKEDITOR.replace(this.element, typeof Template !== "undefined" && Template !== null ? (_ref = Template.currentData) != null ? _ref._ckeditor : void 0 : void 0);
  ...
  CKEditor.prototype._updateTextarea = function() {
...
Main = (function() {
  function Main() {
    ...
    app.basePath = ((_ref = document.querySelector('base')) != null ? _ref.getAttribute('href') : void 0) || '';
